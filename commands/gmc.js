...
const fs = require('fs');
const emojis = [`:cross:`, `:raised_hands:`, `:pray:`, `:heart:`, `:purple_heart:`, `:orange_heart:`, `:green_heart:`, `:yellow_heart:`, `:blue_heart:`, `:white_heart:`, `:sparkling_heart:`, `:cupid:`,
...
`<:dal:905143312061698058>`, `<:dal2:905143807501303918>`, `<:alx:918560013222567976>`, `<:frost:955286584582877245>`,
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        interaction.reply(emojis[spot1] + emojis[spot2] + emojis[spot3] + emojis[spot4] + emojis[spot5] + `:regional_indicator_g:` + `:regional_indicator_m:` + `:regional_indicator_c:` +
